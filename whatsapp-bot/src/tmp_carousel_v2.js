...
const dataPath = path.join(__dirname, "..", "data", "manus_ai_carousel_v2.json");
const data = JSON.parse(fs.readFileSync(dataPath, "utf8"));

const designer = new DesignerService(path.join(__dirname, ".."));

async function generate() {
    console.log(`🚀 Iniciando a geração V2 do carrossel: ${data.tema}`);
    ...
    console.log(`\n🎉 Carrossel gerado com sucesso na pasta: ${data.pasta_destino}`);
}
